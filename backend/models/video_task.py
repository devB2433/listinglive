...
class VideoTask(Base):
    ...
    service_tier: Mapped[str] = mapped_column(String(16), nullable=False, default="standard", index=True)
    ...
    provider_last_polled_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
