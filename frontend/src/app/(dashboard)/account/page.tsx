...
export default function AccountPage() {
  ...
  if (loading) {
    return <PageLoading text={translate("dashboard.accountPage.loading")} />;
  }
    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border bg-white p-6">
        ...
        <div className="mt-6 space-y-3">
          ...
          {logos.length === 0 && <div className="rounded-xl border border-dashed p-4 text-sm text-gray-500">{translate("dashboard.accountPage.noLogos")}</div>}
          {logos.map((logo) => (
